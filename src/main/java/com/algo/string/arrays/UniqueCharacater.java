...
public class UniqueCharacater {
	...
	public static void main(String[] args) {
		// System.out.println("Contains Unique Chracters: " + new UniqueCharacater().containsUniqueChracter("WADI"));

		System.out.println("Contains Unique Chracters: " + new UniqueCharacater().isUniqueChars("VIJAYKUMR"));
	}
	/**
	 * 
